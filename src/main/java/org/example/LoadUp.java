...
public class LoadUp {
    ...
    public static void loadUp(ArrayList<Product> machine){
        machine.add(new Product(1, "Nut Bar", "Cereal Bar", randomIntQuantity.nextInt(21),  80));
        machine.add(new Product(2, "Mars Bar", "Candy Bar", randomIntQuantity.nextInt(21),  70));
        ...
        machine.add(new Product(10, "Orange Juice", "Fruit Juice", randomIntQuantity.nextInt(21),  110));
        machine.add(new Product(11, "Pineapple Juice", "Fruit Juice", randomIntQuantity.nextInt(21),  110));
